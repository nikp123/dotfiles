...
if pkg.has("telescope.nvim") then
   ...
   lsp.on_attach(function(_, bufnr)
      ...
      buf_spc(bufnr, "le", ts"lsp_workspace_diagnostics", "Errors")
...
-- map ;; to adding ; at the end of the line
--vim.cmd([[
--	imap ;; <esc>A;
--]])
...
-- Change the CursorHold time to 1 second
vim.g.updatetime=1000

-- Show diagnostics window when CursorHold is active
vim.cmd [[autocmd CursorHold * lua vim.lsp.diagnostic.show_line_diagnostics()]]
vim.cmd [[autocmd CursorHoldI * silent! lua vim.lsp.buf.signature_help()]]

-- Auto-update file on file change
