...
CreateLink /etc/systemd/system/multi-user.target.requires/boot-zram.service /etc/systemd/system/boot-zram.service

CopyFile /etc/systemd/system/boot-zram.service
